...
def test_parametrize(phone):
    ...
    payload = ('action=sendAjax&phone=%2B375296971077&form_name=%D0%9E%D1%81%D1%82%D0%B0%D0%BB%D0%B8%D1%81%D1%8C%20%D0%'
               ...
               '=HOSTER_FEEDBACK_FORM_CONTACTS&session_id=828517621.1732273783')
    headers = {
        'accept': '*/*',
        ...
        'cookie': '_ym_uid=1713717215907008145; hg-client-security=2o9xQ0sq1BBqRU9vFmuT2Bl5DPg; '
                  ...
                  'cookie_technical=y; cookie_targeting=y; _gcl_au=1.1.1490582911.1732273783;'
                  ' _ga=GA1.1.828517621.1732273783; tmr_lvid=7beb4ff144b4073fea92befa4dc5e2f9; '
                  'tmr_lvidTS=1732273783201; _tt_enable_cookie=1; _ttp=IW79l-7ERVU8UNpHZrTQVWD6mGn.tt.1;'
                  ...
                  'popmechanic_sbjs_migrations=popmechanic_1418474375998%3D1%7C%7C%7C1471519752600%3D1%7C'
                  '%7C%7C1471519752605%3D1; _ym_d=1732273787; '
                  '_ymab_param=OQfqJeqeAwlzlR1jAidJN8-NL7znBtoknYgpvwyx9o7mtcAf8Awk0FDpyHRDw1cORV3GYdWbh9Ym6U8LIh_'
                  'vqRZBVrQ; BITRIX_CONVERSION_CONTEXT_s1=%7B%22ID%22%3A3%2C%22EXPIRE%22%3A1732481940%2C%22UNIQUE'
                  '%22%3A%5B%22conversion_visit_day%22%5D%7D; domain_sid=htsMTmdfoF_Bup6GY3A7E%3A1732464893278; '
                  '_ym_isad=2; PHPSESSID=vBxfvjrH1NSGNo4rxCbhiV63aruIL5zP; _ga_261820121=GS1.1.1732467885.5.1.1'
                  '732467887.0.0.1463500371; tmr_detect=0%7C1732467889213; _ym_visorc=w; _ga_9JLLFGM9W7=GS1.1.1'
                  '732467438.6.1.1732467891.42.0.0; PHPSESSID=j3yBch56x90rHIHxig1IJG72hOHE4ZQ0',
